...
from dataset_por2del import CreateDatasetSynthesis
...
def train_syndiff(rank, gpu, args):
    ...
    # wandb.watch(disc_diffusive_1, log="all")
    # wandb.watch(disc_diffusive_2, log="all")
    ...
    for epoch in range(init_epoch, args.num_epoch):
        ...
        for iteration, (x1, x2) in enumerate(data_loader):
            ...
            # wandb.log({"errD": errD.item(), "errD_cycle": errD_cycle.item()})
            ...
            # wandb.log({"errG": errG.item(), "errG_cycle": errG_cycle.item(), "errG_L1": errG_L1.item(), "errG_adv": errG_adv.item(), "errG_cycle_adv": errG_cycle_adv.item()})
        ...
        # wandb.log({"val_psnr_0": np.nanmean(val_psnr_values[0,epoch,:]), "val_psnr_1": np.nanmean(val_psnr_values[1,epoch,:])})
...
if __name__ == '__main__':
    # wandb.login(key='d443ce048a8c4a1b0ca686aaf6313884bd5297b1')
    ...
    # wandb.init(
    #     project='bile-duct-SynDiff',
    #     entity='kist-han',
    #     name='SynDiff_output3' + args.settings,
    #     sync_tensorboard=True,
    #     reinit=True
    # )
    # wandb.config.num_gpus = 1
...
'''
export LD_LIBRARY_PATH=/home/interns/anaconda3/envs/syn_diff/lib:$LD_LIBRARY_PATH
'''

# python3 train_pre2art.py --image_size 256 --exp exp --num_channels 2 --num_channels_dae 64 --ch_mult 1 1 2 2 4 4 --num_timesteps 4 --num_res_blocks 2 --batch_size 1 --contrast1 PRE --contrast2 ART --num_epoch 500 --ngf 64 --embedding_type positional --use_ema --ema_decay 0.999 --r1_gamma 1. --z_emb_dim 256 --lr_d 1e-4 --lr_g 1.6e-4 --lazy_reg 10 --num_process_per_node 4 --save_content --local_rank 0 --input_path ../../seo
# lhac/dataset_hcc_perclass --output_path ./output_epoch500_gpu1_256x256_pre2art
# /for/results --port_num 5001